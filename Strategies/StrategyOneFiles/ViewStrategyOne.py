...
class ViewStrategyOne: 
    ...
    def toStart(self, moneyStart, waitCrash, autoStop):
        ...
        StrategyOne.startStrategy(moneyStart, waitCrash, autoStop, self.thread)
    ...
    def startScreen(self):
        ...
        strategyScren.geometry("900x350")
        ...
        ctk.CTkLabel(strategyScren, text="Na estratégia 1 você deve configurar o valor da aposta, quantos CRASHES deve esperar até que apostar e o valor que configurou na blaze de auto-retirar.").pack()
        ctk.CTkLabel(strategyScren, text="O robô irá apostar APENAS após a quantidade de crash do valor de auto-stop.").pack()
        ctk.CTkLabel(strategyScren, text="Exemplo: Seu auto-stop é de 2x, e você colocou para esperar 5 crashes, o sistema vai esperar crashar 5x o valor menor que 2x, para apostar.").pack()
