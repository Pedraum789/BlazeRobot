...
class ViewStrategyOne:
    ...
    def toStart(self, moneyStart, waitCrash, autoStop, stopLose, stopWin, strategyScren):
        ...
        StrategyOne.StrategyOne(moneyStart, waitCrash, autoStop, self.thread, stopLose, stopWin, strategyScren, self.logText, self.progressbarStart, self.progressBarLose).startStrategy()
